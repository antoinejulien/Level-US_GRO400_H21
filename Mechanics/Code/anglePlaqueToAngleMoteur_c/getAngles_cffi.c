...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 6), // void()(double, double, double, double *)
...
static void _cffi_d_getAngles(double x0, double x1, double x2, double * x3)
{
  getAngles(x0, x1, x2, x3);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_getAngles(PyObject *self, PyObject *args)
{
  double x0;
  double x1;
  double x2;
  ...
  if (!PyArg_UnpackTuple(args, "getAngles", 4, 4, &arg0, &arg1, &arg2, &arg3))
    return NULL;
...
#else
#  define _cffi_f_getAngles _cffi_d_getAngles
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "getAngles", (void *)_cffi_f_getAngles, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_getAngles },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_getAngles_cffi(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_getAngles_cffi(void) { return NULL; }
#  else
     initgetAngles_cffi(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit_getAngles_cffi(void)
{
  return _cffi_init("getAngles_cffi", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initgetAngles_cffi(void)
{
  _cffi_init("getAngles_cffi", 0x2601, &_cffi_type_context);
}
#endif
