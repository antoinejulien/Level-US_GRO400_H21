  ...
  const coder_internal_ref *hauteurAxeMoteur, const double X[9])
{
  ...
  return scale * sqrt(ErrorInSetOfFunctions);
}
  ...
  const coder_internal_ref *hauteurAxeMoteur, const double VAR[9], double RHS[9])
{
  ...
  RHS[0] = distancePlaqueTop_x->contents - rayonDistanceAncrageEtPivot->contents
    * cos(anglePlaqueTop_y->contents) * sin(anglePlaqueTop_z->contents);
  RHS[1] = (((distancePlaqueTop_y->contents + longueurBras2->contents * cos
              (angleBras1Middle->contents - angleMot1->contents)) +
             rayonDistanceAncrageEtPivot->contents * (cos
              (anglePlaqueTop_x->contents) * cos(anglePlaqueTop_z->contents) -
              sin(anglePlaqueTop_x->contents) * sin(anglePlaqueTop_y->contents) *
              sin(anglePlaqueTop_z->contents))) - rayonDistanceMoteur->contents)
    - longueurBras1->contents * cos(angleMot1->contents);
  RHS[2] = (((hauteurPlaqueTop->contents + rayonDistanceAncrageEtPivot->contents
              * (sin(anglePlaqueTop_x->contents) * cos
                 (anglePlaqueTop_z->contents) + sin(anglePlaqueTop_y->contents) *
                 cos(anglePlaqueTop_x->contents) * sin
                 (anglePlaqueTop_z->contents))) - hauteurAxeMoteur->contents) -
            longueurBras1->contents * sin(angleMot1->contents)) -
    longueurBras2->contents * sin(angleBras1Middle->contents -
    angleMot1->contents);
  RHS[3] = ((((distancePlaqueTop_x->contents + 0.8660254037844386 *
               longueurBras2->contents * cos(angleBras2Middle->contents -
    angleMot2->contents)) + 0.5 * rayonDistanceAncrageEtPivot->contents * cos
              (anglePlaqueTop_y->contents) * sin(anglePlaqueTop_z->contents)) +
             0.8660254037844386 * rayonDistanceAncrageEtPivot->contents * cos
             (anglePlaqueTop_y->contents) * cos(anglePlaqueTop_z->contents)) -
            0.8660254037844386 * rayonDistanceMoteur->contents) -
    0.8660254037844386 * longueurBras1->contents * cos(angleMot2->contents);
  RHS[4] = ((((0.5 * rayonDistanceMoteur->contents +
               distancePlaqueTop_y->contents) + 0.5 * longueurBras1->contents *
              cos(angleMot2->contents)) + 0.8660254037844386 *
             rayonDistanceAncrageEtPivot->contents * (cos
              (anglePlaqueTop_x->contents) * sin(anglePlaqueTop_z->contents) +
              sin(anglePlaqueTop_x->contents) * sin(anglePlaqueTop_y->contents) *
              cos(anglePlaqueTop_z->contents))) - 0.5 * longueurBras2->contents *
            cos(angleBras2Middle->contents - angleMot2->contents)) - 0.5 *
    rayonDistanceAncrageEtPivot->contents * (cos(anglePlaqueTop_x->contents) *
    cos(anglePlaqueTop_z->contents) - sin(anglePlaqueTop_x->contents) * sin
    (anglePlaqueTop_y->contents) * sin(anglePlaqueTop_z->contents));
  RHS[5] = ((((hauteurPlaqueTop->contents + 0.8660254037844386 *
               rayonDistanceAncrageEtPivot->contents * (sin
    (anglePlaqueTop_x->contents) * sin(anglePlaqueTop_z->contents) - sin
    (anglePlaqueTop_y->contents) * cos(anglePlaqueTop_x->contents) * cos
    (anglePlaqueTop_z->contents))) - hauteurAxeMoteur->contents) -
             longueurBras1->contents * sin(angleMot2->contents)) -
            longueurBras2->contents * sin(angleBras2Middle->contents -
             angleMot2->contents)) - 0.5 * rayonDistanceAncrageEtPivot->contents
    * (sin(anglePlaqueTop_x->contents) * cos(anglePlaqueTop_z->contents) + sin
       (anglePlaqueTop_y->contents) * cos(anglePlaqueTop_x->contents) * sin
       (anglePlaqueTop_z->contents));
  RHS[6] = ((((0.8660254037844386 * rayonDistanceMoteur->contents +
               distancePlaqueTop_x->contents) + 0.8660254037844386 *
              longueurBras1->contents * cos(angleMot3->contents)) + 0.5 *
             rayonDistanceAncrageEtPivot->contents * cos
             (anglePlaqueTop_y->contents) * sin(anglePlaqueTop_z->contents)) -
            0.8660254037844386 * longueurBras2->contents * cos
            (angleBras3Middle->contents - angleMot3->contents)) -
    0.8660254037844386 * rayonDistanceAncrageEtPivot->contents * cos
    (anglePlaqueTop_y->contents) * cos(anglePlaqueTop_z->contents);
  RHS[7] = ((((0.5 * rayonDistanceMoteur->contents +
               distancePlaqueTop_y->contents) + 0.5 * longueurBras1->contents *
              cos(angleMot3->contents)) - 0.5 * longueurBras2->contents * cos
             (angleBras3Middle->contents - angleMot3->contents)) -
            0.8660254037844386 * rayonDistanceAncrageEtPivot->contents * (cos
             (anglePlaqueTop_x->contents) * sin(anglePlaqueTop_z->contents) +
             sin(anglePlaqueTop_x->contents) * sin(anglePlaqueTop_y->contents) *
             cos(anglePlaqueTop_z->contents))) - 0.5 *
    rayonDistanceAncrageEtPivot->contents * (cos(anglePlaqueTop_x->contents) *
    cos(anglePlaqueTop_z->contents) - sin(anglePlaqueTop_x->contents) * sin
    (anglePlaqueTop_y->contents) * sin(anglePlaqueTop_z->contents));
  RHS[8] = ((((hauteurPlaqueTop->contents - hauteurAxeMoteur->contents) -
              longueurBras1->contents * sin(angleMot3->contents)) -
             longueurBras2->contents * sin(angleBras3Middle->contents -
              angleMot3->contents)) - 0.5 *
            rayonDistanceAncrageEtPivot->contents * (sin
             (anglePlaqueTop_x->contents) * cos(anglePlaqueTop_z->contents) +
             sin(anglePlaqueTop_y->contents) * cos(anglePlaqueTop_x->contents) *
             sin(anglePlaqueTop_z->contents))) - 0.8660254037844386 *
    rayonDistanceAncrageEtPivot->contents * (sin(anglePlaqueTop_x->contents) *
    sin(anglePlaqueTop_z->contents) - sin(anglePlaqueTop_y->contents) * cos
    (anglePlaqueTop_x->contents) * cos(anglePlaqueTop_z->contents));
}
  ...
  *hauteurAxeMoteur, const double VAR[9], double GradientAtX[9])
{
  ...
  COEF[0] = -1.0;
  COEF[18] = rayonDistanceAncrageEtPivot->contents * cos
    (anglePlaqueTop_y->contents) * cos(anglePlaqueTop_z->contents);
  COEF[10] = -1.0;
  COEF[19] = rayonDistanceAncrageEtPivot->contents * (cos
    (anglePlaqueTop_x->contents) * sin(anglePlaqueTop_z->contents) + sin
    (anglePlaqueTop_x->contents) * sin(anglePlaqueTop_y->contents) * cos
    (anglePlaqueTop_z->contents));
  COEF[28] = -longueurBras1->contents * sin(angleMot1->contents) -
    longueurBras2->contents * sin(angleBras1Middle->contents -
    angleMot1->contents);
  COEF[55] = longueurBras2->contents * sin(angleBras1Middle->contents -
    angleMot1->contents);
  COEF[20] = rayonDistanceAncrageEtPivot->contents * (sin
    (anglePlaqueTop_x->contents) * sin(anglePlaqueTop_z->contents) - sin
    (anglePlaqueTop_y->contents) * cos(anglePlaqueTop_x->contents) * cos
    (anglePlaqueTop_z->contents));
  COEF[29] = longueurBras1->contents * cos(angleMot1->contents) -
    longueurBras2->contents * cos(angleBras1Middle->contents -
    angleMot1->contents);
  COEF[56] = longueurBras2->contents * cos(angleBras1Middle->contents -
    angleMot1->contents);
  COEF[3] = -1.0;
  COEF[21] = 0.5 * rayonDistanceAncrageEtPivot->contents * cos
    (anglePlaqueTop_y->contents) * (1.732050807568877 * sin
    (anglePlaqueTop_z->contents) - cos(anglePlaqueTop_z->contents));
  COEF[39] = -0.8660254037844386 * longueurBras1->contents * sin
    (angleMot2->contents) - 0.8660254037844386 * longueurBras2->contents * sin
    (angleBras2Middle->contents - angleMot2->contents);
  COEF[66] = 0.8660254037844386 * longueurBras2->contents * sin
    (angleBras2Middle->contents - angleMot2->contents);
  COEF[13] = -1.0;
  COEF[22] = 0.5 * rayonDistanceAncrageEtPivot->contents * (((1.732050807568877 *
    sin(anglePlaqueTop_x->contents) * sin(anglePlaqueTop_y->contents) * sin
    (anglePlaqueTop_z->contents) - 1.732050807568877 * cos
    (anglePlaqueTop_x->contents) * cos(anglePlaqueTop_z->contents)) - cos
    (anglePlaqueTop_x->contents) * sin(anglePlaqueTop_z->contents)) - sin
    (anglePlaqueTop_x->contents) * sin(anglePlaqueTop_y->contents) * cos
    (anglePlaqueTop_z->contents));
  COEF[40] = 0.5 * longueurBras1->contents * sin(angleMot2->contents) + 0.5 *
    longueurBras2->contents * sin(angleBras2Middle->contents -
    angleMot2->contents);
  COEF[67] = -0.5 * longueurBras2->contents * sin(angleBras2Middle->contents -
    angleMot2->contents);
  COEF[23] = -0.5 * rayonDistanceAncrageEtPivot->contents * (((sin
    (anglePlaqueTop_x->contents) * sin(anglePlaqueTop_z->contents) +
    1.732050807568877 * sin(anglePlaqueTop_x->contents) * cos
    (anglePlaqueTop_z->contents)) + 1.732050807568877 * sin
    (anglePlaqueTop_y->contents) * cos(anglePlaqueTop_x->contents) * sin
    (anglePlaqueTop_z->contents)) - sin(anglePlaqueTop_y->contents) * cos
    (anglePlaqueTop_x->contents) * cos(anglePlaqueTop_z->contents));
  COEF[41] = longueurBras1->contents * cos(angleMot2->contents) -
    longueurBras2->contents * cos(angleBras2Middle->contents -
    angleMot2->contents);
  COEF[68] = longueurBras2->contents * cos(angleBras2Middle->contents -
    angleMot2->contents);
  COEF[6] = -1.0;
  COEF[24] = -0.5 * rayonDistanceAncrageEtPivot->contents * cos
    (anglePlaqueTop_y->contents) * (cos(anglePlaqueTop_z->contents) +
    1.732050807568877 * sin(anglePlaqueTop_z->contents));
  COEF[51] = 0.8660254037844386 * longueurBras1->contents * sin
    (angleMot3->contents) + 0.8660254037844386 * longueurBras2->contents * sin
    (angleBras3Middle->contents - angleMot3->contents);
  COEF[78] = -0.8660254037844386 * longueurBras2->contents * sin
    (angleBras3Middle->contents - angleMot3->contents);
  COEF[16] = -1.0;
  COEF[25] = 0.5 * rayonDistanceAncrageEtPivot->contents * (((1.732050807568877 *
    cos(anglePlaqueTop_x->contents) * cos(anglePlaqueTop_z->contents) - cos
    (anglePlaqueTop_x->contents) * sin(anglePlaqueTop_z->contents)) -
    1.732050807568877 * sin(anglePlaqueTop_x->contents) * sin
    (anglePlaqueTop_y->contents) * sin(anglePlaqueTop_z->contents)) - sin
    (anglePlaqueTop_x->contents) * sin(anglePlaqueTop_y->contents) * cos
    (anglePlaqueTop_z->contents));
  COEF[52] = 0.5 * longueurBras1->contents * sin(angleMot3->contents) + 0.5 *
    longueurBras2->contents * sin(angleBras3Middle->contents -
    angleMot3->contents);
  COEF[79] = -0.5 * longueurBras2->contents * sin(angleBras3Middle->contents -
    angleMot3->contents);
  COEF[26] = -0.5 * rayonDistanceAncrageEtPivot->contents * (((sin
    (anglePlaqueTop_x->contents) * sin(anglePlaqueTop_z->contents) -
    1.732050807568877 * sin(anglePlaqueTop_x->contents) * cos
    (anglePlaqueTop_z->contents)) - 1.732050807568877 * sin
    (anglePlaqueTop_y->contents) * cos(anglePlaqueTop_x->contents) * sin
    (anglePlaqueTop_z->contents)) - sin(anglePlaqueTop_y->contents) * cos
    (anglePlaqueTop_x->contents) * cos(anglePlaqueTop_z->contents));
  COEF[53] = longueurBras1->contents * cos(angleMot3->contents) -
    longueurBras2->contents * cos(angleBras3Middle->contents -
    angleMot3->contents);
  COEF[80] = longueurBras2->contents * cos(angleBras3Middle->contents -
    angleMot3->contents);
  p = true;
  for (br = 0; br < 81; br++) {
  ...
  double hauteurPlaqueTop, double Output[3])
{
  ...
  /*   Converted from mm  */
  longueurBras1.contents = 0.07619999999999999+0.05;

  /*   Converted from in  */
  longueurBras2.contents = 0.1016+0.015;

  /*   Converted from in  */
  rayonDistanceAncrageEtPivot.contents = 0.14833000000000002 + .02 -0.08;
  ...
  for (k = 0; k < 9; k++) {
    VAR[k] = fabs(ErrorInConvergenceOfSolution[k]);
  }
...
/* End of code generation (anglePlaqueToAngleMoteur.c) */
